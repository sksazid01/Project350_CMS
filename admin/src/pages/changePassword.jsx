    ...
    <div className="bg-[#0e1726] min-h-screen">
      ...
      <div className="pt-5">
        <div className="flex items-center justify-center min-h-screen bg-[#0e1726]">
          <div className="panel w-full max-w-md bg-[#191e3a] border border-[#1b2e4b]">
            <h2 className="text-2xl font-bold mb-6 text-center text-white-light">Change Password</h2>
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="oldPassword" className="block mb-2 text-white-light">Current Password</label>
                <input
                  id="oldPassword"
                  type="password"
              ...
              <div>
                <label htmlFor="newPassword" className="block mb-2 text-white-light">New Password</label>
                <input
                  id="newPassword"
                  type="password"
              ...
              <div>
                <label htmlFor="confirmPassword" className="block mb-2 text-white-light">Confirm New Password</label>
                <input
                  id="confirmPassword"
                  type="password"
              ...
              >
                {isSubmitting ? (
                  <>
                    <svg aria-hidden="true" className="inline w-4 h-4 mr-2 text-gray-600 animate-spin fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
