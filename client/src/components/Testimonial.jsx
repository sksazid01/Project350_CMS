    ...
    feedbacks = [
        {
            id: 1,
            name: 'Prince AL AMIN',
            role: 'Founder of SUSTclubs',
            thumbnail: '/assets/images/alaminxpro.png',
            message:
                "SUSTclubs was born from a vision to streamline club management at our university. It's incredible to see how it has grown and positively impacted student engagement across various clubs. This platform is revolutionizing the way we connect and collaborate on campus.",
        },
        {
            id: 2,
            name: 'Harique Jaif',
            role: 'CEO of SUSTclubs',
            thumbnail: '/assets/images/jaif-square.png',
            message:
                "As CEO, I've witnessed firsthand the transformative power of SUSTclubs. It's not just a management system; it's a catalyst for student leadership and community building. The efficiency and connectivity it brings to club operations are unparalleled.",
        },
        {
            id: 3,
            name: 'Yeash Ahmed',
            role: 'CTO of SUSTclubs',
            thumbnail: '/assets/images/yeash-square.png',
            message:
                "The technical challenges we've overcome in developing SUSTclubs have been immense, but the results are worth it. Our platform's robust features and user-friendly interface are setting new standards for university club management systems.",
        },
        {
            id: 4,
            name: 'MD. AL AMIN',
            role: 'Software Engineer',
            thumbnail: '/assets/images/alaminxpro-400.png',
            message:
                "Working on SUSTclubs has been a rewarding experience. The codebase is well-structured and scalable, allowing us to continuously add new features and improvements. It's gratifying to see our work directly benefiting the student community at SUST.",
        },
    ],
    className = '',
}) => {
            ...
            {type.toLowerCase() === 'marketing' ? (
                ...
                >
                    ...
                    <div className="bottom-0 z-[1] mt-5 flex items-center justify-end gap-4 ltr:right-28 rtl:left-28 sm:absolute sm:mt-0 sm:justify-end">
                        <Link to="#" className="text-sm font-extrabold text-white transition hover:text-secondary dark:hover:text-secondary">
                            {' '}
                            View All{' '}
                        </Link>
