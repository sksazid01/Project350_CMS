            ...
            <section className="bg-gradient-to-t from-white/[55%] to-transparent py-8 dark:bg-none lg:py-12">
                <div className="container flex justify-center items-center">
                    <div className="relative z-10 w-full max-w-3xl">
                        <form onSubmit={onSubmit} className="rounded-3xl bg-white px-4 py-8 dark:bg-gray-dark lg:px-8">
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    <div className="heading text-center ltr:lg:text-left rtl:lg:text-right">
                        <h4 className="sm:!leading-[50px]">Shahjalal University of Science and Technology</h4>
                    </div>
                    <div className="mb-10 grid gap-[30px] md:grid-cols-2 lg:grid-cols-3">
                        <div className="rounded-[32px] bg-white px-4 py-6 dark:bg-gray-dark md:p-7" data-aos="fade-up" data-aos-duration="1000">
                            <div className="mb-4 flex items-center gap-2 text-secondary">
                                ...
                                <span className="text-[22px] font-bold">Contact us</span>
                            </div>
                            <a
                        ...
                        <div className="rounded-[32px] bg-white px-4 py-6 dark:bg-gray-dark md:p-7" data-aos="fade-up" data-aos-duration="1000">
                            <div className="mb-4 flex items-center gap-2 text-primary">
                                ...
                                <span className="text-[22px] font-bold">Email us</span>
                            </div>
                            <a
                        ...
                        <div className="rounded-[32px] bg-white px-4 py-6 dark:bg-gray-dark md:p-7" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <h5 className="font-bold text-black dark:text-white lg:text-lg">Sylhet-3114, Bangladesh</h5>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="mx-auto text-center sm:w-[430px]">
                        <div className="heading mb-6">
                            <h4>Join your dream club</h4>
                        </div>
                        <p className="text-lg font-bold">Become a member of your dream club and make your university life more fun and exciting.</p>
                        <div className="mt-12 flex items-center justify-between gap-4 font-extrabold sm:gap-7">
                            <Link to="/" className="btn w-full bg-secondary text-base capitalize text-white hover:bg-gray/10 hover:text-gray sm:text-lg">
                                Get Started
                            </Link>
                            <Link to="/about-us" className="btn w-full bg-gray/10 text-base capitalize text-gray sm:text-lg">
                                Learn More
                            </Link>
                        </div>
                    </div>
